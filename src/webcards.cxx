...
string::size_type parseArguments(arguments_t &arguments)
{
	...
	if ( arguments.packageBranch.size() == 0)
		arguments.packageBranch="systemd";
...
void searchpkg(contentInfo_t &contentInfo, arguments_t &arguments)
{
	...
	if ( arguments.packageBranch == "systemd" )
		contentInfo.text.push_back( "      <input type=\"radio\" name=\"branch\" value=\"systemd\" checked=\"checked\" /> systemd");
	else
		contentInfo.text.push_back( "      <input type=\"radio\" name=\"branch\" value=\"systemd\" /> systemd");
	contentInfo.text.push_back( "     <br>");
	if ( arguments.packageBranch == "testingd" )
		contentInfo.text.push_back( "      <input type=\"radio\" name=\"branch\" value=\"testingd\" checked=\"checked\"/> testingd");
	else
		contentInfo.text.push_back( "      <input type=\"radio\" name=\"branch\" value=\"testingd\" /> testingd");
	contentInfo.text.push_back( "     <br>");
