...
enum ErrorEnum {
	...
	ERROR_ENUM_PACKAGE_IN_BASESYSTEM,
...
enum ActionEnum {
	...
	ACTION_ENUM_PKG_PREREMOVE_START,
	ACTION_ENUM_PKG_PREREMOVE_END,
	...
	ACTION_ENUM_PKG_POSTREMOVE_START,
	ACTION_ENUM_PKG_POSTREMOVE_END,
